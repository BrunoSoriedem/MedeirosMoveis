                            ...
                            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li data-aos="fade-left" data-aos-delay="400">
                                            <a class="dropdown-item"
                                                href="/Medeiros-Moveis/produto?categoria=planejados">
                                                <div class="efeito">Planejados</div>
                                            </a>
                                        </li>
                                        <li data-aos="fade-left" data-aos-delay="500">
                                            <a class="dropdown-item"
                                                href="/Medeiros-Moveis/produto?categoria=estofados">
                                ...
                                <li class="nav-item master-dropdown" data-aos="fade-up" data-aos-delay="500">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li data-aos="fade-left" data-aos-delay="600">
                                            <a class="dropdown-item" href="cadUsuarioMaster">
                                                <div class="efeito">Usuário</div>
                                            </a>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li class="nav-item user-dropdown" data-aos="fade-up" data-aos-delay="600"
                                    ...
                                    <span class="escrita-enter">
                                        <i class="fa-solid fa-circle-user" id="icon-user"></i>
                                    </span>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="cadastrar">
                                                <div class="efeito">Cadastrar</div>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="dropdown-item" href="areaUsuario">
                                        ...
                                        <li>
                                            <a class="dropdown-item" href="dashboard">
                                                <div class="efeito">DashBoard</div>
                                            </a>
                                        </li>
                                        <?php endif; ?>
                ...
                <div class="container-footer">
                    <div class="footer-col">
                        ...
                        <div class="footer-social">
                            ...
                            <a href="https://wa.me/554499870212?text=Olá,%20gostaria%20de%20um%20orçamento"
