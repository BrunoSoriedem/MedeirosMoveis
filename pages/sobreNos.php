...
<section>
    <div class="page-wrapper">
                ...
                <div class="padding-vertical-xlarge">
                    <div class="timeline-main_heading-wrapper">
                        <div class="margin-bottom-medium">
                            <h2 class="nossa-historia" data-aos="fade-up" data-aos-delay="100">Nossa História</h2>
                        </div>
                        <p class="paragraph-large" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="section-timeline">
            ...
            <div class="espaco-tineline" style="height: 5vh;"></div>
        </div>
    </div>
</section>

<section class="collection" id="section-equipe">
        ...
        <div class="equipe">
            <div class="conteudo">
                ...
                <div class="escrita-equipe">
                    ...
                    <h3 class="titulo-equipe">Equipe de Profissionais Altamente Focados</h3>
...
<section class="localizacao-section">
    ...
    <div class="localizacao-container">
        <div class="localizacao-texto">
            <p>
                Estamos localizados em uma pequena cidade no interior do Paraná,
                chamada Juranda — carinhosamente conhecida como
                "Juranda, a Cidade do Milagre".
                <br><br>
                Desde a sua inauguração, a Medeiros Móveis já passou por três endereços
                diferentes, sempre realizando reformas e melhorias ao longo do tempo.
                Tudo isso com um único objetivo: oferecer um atendimento
                cada vez melhor a você, nosso <strong>amigo e cliente</strong>.
                <br><br>
                Confira nossa localização ao lado e venha nos fazer uma visita.
