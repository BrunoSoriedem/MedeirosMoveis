...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$validator->validate()) {
        ...
        $usuarioService = new MasterService();
    ...
    <div class="contact-container">
        <div class="login-container">
            <div class="login-header">
                <h2 class="login-title">Crie uma conta com Acesso Master</h2>
            ...
            <div class="login-form">
                ...
                <form method="POST" action="">
                    ...
                    <p class="infoSenha">
                        Senha deve conter 1 letra maiúscula, 1 minúscula, 1 número e 1 caractere.
                    </p>
